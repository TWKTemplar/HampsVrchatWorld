Shader "Hidden/Locked/.poiyomi/Poiyomi 8.1/Poiyomi Pro/6f15550908d40ba46990940acc38cba2"
{
	Properties
	{
 ...
 #define _RIMSTYLE_POIYOMI 
			...
			void ApplyRimLighting(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiCam poiCam, in PoiLight poiLight, in PoiMods poiMods)
			{
				...
				float rimWidth = lerp( - .05, 1, float(0.139));
				...
				float rim = 1 - smoothstep(min(float(0.039), rimWidth), rimWidth, viewDotNormal);
